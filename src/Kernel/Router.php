...
use JustinExample\Middlewares\MiddlewareInterface;
use Exception;
use TypeError;
...
class Router
{
     ...
     * @return void
     */
    private function executeMiddlewares(bool $priority_type, Context $context): void
    {
        $middlewares = $priority_type ? $this->middlewares_before : $this->middlewares_after;
    ...
    public static function run(): void
    {
        ...
        foreach ($channels as $channel) {
            ...
            $channel->executeMiddlewares(true, $context);
            ...
            // Do middleware_after
            $channel->executeMiddlewares(false, $context);
            if (!$channel->allow_next_middleware) {
